       ...
       <View style={styles.header}>
        ...
        <ScrollView>
              <Text style={isStyle ? [styles.SongDark, {fontSize: slide}] : [styles.SongLight, {fontSize: slide}]} >
                  ...
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>F#          E     F#          E     F#{'\n'}</Text>
                  ...
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>E           F#          G#m            F#/A# {'\n'}</Text>
                  Не за то, что сделал я, но по милости Твоей. {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>G#m            F#/A#          E           F# {'\n'}</Text>
                  ...
                  И мгновенно увядает. {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>F#          E           F# {'\n'}</Text>
                  Пришел в мир и исчезну, как утренний туман. {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>H           H/A#           G#m {'\n'}</Text>
                  Но Ты мольбам моим внимаешь. {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>F#          E {'\n'}</Text>
                  Если упаду, прощаешь.  {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>F#          E           H     E    G#m    F#{'\n'}</Text>
