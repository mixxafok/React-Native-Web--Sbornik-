...
export default function ZaLoveZaMilost( {namSong} ) {
       ...
       <View style={modalOpen ? styles.modViewChords : {display:"none"}}>
        ...
        <ScrollView>
                <Text style={isStyle ? [styles.SongDark, {fontSize: slide}] : [styles.SongLight, {fontSize: slide}]} >
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}> {major[8+start]}7                                                {minor[1+start]}   {major[8+start]}7{'\n'}</Text>
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{major[11+start]}7            {major[4+start]}/{major[8+start]}{'\n'}</Text>
