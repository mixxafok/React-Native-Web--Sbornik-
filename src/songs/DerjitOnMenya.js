       ...
       <View style={styles.header}>
        ...
        <ScrollView>
              <Text style={isStyle ? styles.SongDark : styles.SongLight} >
                  ...
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>C       D       G       C       H       Em {'\n'}</Text>               
                  Чтобы мне не потерять вечного огня, {'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>C       D       G         C        D       G {'\n'}</Text>
                  Должен Он меня держать. Держит Он меня. {'\n'}{'\n'}

                  <Text style={styles.Couplet} >Припев: {'\n'}</Text>
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>C       D       Em{'\n'}</Text>
                  Держит Он меня,{'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>Em       D       G{'\n'}</Text>
                  Держит Он меня.{'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>G       Am       G       C{'\n'}</Text>
                  Охраняя и любя,{'\n'}
                  <Text style={isStyle ? styles.AccordesDark : styles.AccordesLight}>C       D       G{'\n'}</Text>
                  Держит Он меня.{'\n'}{'\n'}
