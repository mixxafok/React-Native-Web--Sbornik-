...
export default function NaychiMenya( {namSong} ) {
       ...
       <View style={modalOpen ? styles.modViewChords : {display:"none"}}>
        ...
        <ScrollView>
              <Text style={isStyle ? [styles.SongDark, {fontSize: slide}] : [styles.SongLight, {fontSize: slide}]} >
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{minor[8+start]}               {major[6+start]}  {major[11+start]}  {major[8+start]}{'\n'}</Text>
