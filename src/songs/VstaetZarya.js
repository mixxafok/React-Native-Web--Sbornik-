...
export default function VstaetZarya( {namSong} ) {
       ...
       <View style={modalOpen ? styles.modViewChords : {display:"none"}}>
        ...
        <ScrollView>
              <Text style={isStyle ? [styles.SongDark, {fontSize: slide}] : [styles.SongLight, {fontSize: slide}]} >
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{minor[1+start]}           {major[3+start]}7         {minor[8+start]}{'\n'}</Text>
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{minor[1+start]}             {major[6+start]}        {major[11+start]}  {major[3+start]}7{'\n'}</Text>
