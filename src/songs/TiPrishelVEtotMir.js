...
export default function TiPrishelVEtotMir( {namSong} ) {
       ...
       <View style={modalOpen ? styles.modViewChords : {display:"none"}}>
        ...
        <ScrollView>
              <Text style={isStyle ? [styles.SongDark, {fontSize: slide}] : [styles.SongLight, {fontSize: slide}]} >
                  ...
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{major[8+start]}          {minor[1+start]}    {major[6+start]}        {major[11+start]}{'\n'}</Text>
                  Ветер, дождь и туман застилают глаза,{'\n'}
                  <Text id={viewAccordes ? null : 'AccordesNone'} style={isStyle ? styles.AccordesDark : styles.AccordesLight}>{minor[8+start]}        {minor[1+start]}    {major[3+start]}        {minor[8+start]}{'\n'}</Text>
